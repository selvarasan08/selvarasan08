...
<a href="https://selvarasan-portfolio.netlify.app" target="_blank">
...
const selvarasan = {
    ...
    achievements: [
        ...
        "🎓 Selected for IDE Bootcamp Phase II - National Innovation Program"
    ],
    openTo: "Relocating anywhere in India 🇮🇳",
...
<img src="https://img.shields.io/badge/OAuth_2.0-4285F4?style=for-the-badge&logo=auth0&logoColor=white"/>
...
### 💰 VelavanFinance Web App
**Live:** [velavanfinance.com](https://velavanfinance.com)

Secure MERN application with JWT auth, protected routes, and role-based dashboards for admins, staff, and customers.

- ⚙️ Optimized Express + MongoDB APIs with aggregation pipelines
- 💸 End-to-end modules for loans, installments & settlements
- 📊 Real-time financial data retrieval with indexing
...
### 📝 Online Assessment Platform (LMS)
Scalable exam system with MCQs, coding challenges & real-time dashboards.

- 🔐 MERN + microservices with JWT & bcrypt security, strict RBAC
- 🖥️ In-browser coding compiler, autosave & anti-malpractice checks
- 📄 Admin panel: CSV uploads, scheduling, jsPDF reporting
...
```text
Junior MERN Stack Developer — Zealous Tech Corp, Salem
March 2025 – June 2025
```
> Architected a full-featured LMS using MERN + Socket.IO for real-time updates, Chart.js/Recharts for dashboards, JWT + bcrypt security, PDF report generation, and QR-based certificate validation via Firebase.
...
- 🥇 **Top 10** — HackIndia Hackathon 2025 (100+ teams)
- 📑 **Presenter** — IEEE ICAAIC 2025 (Real-time bus monitoring system with QR-based passenger access)
- 🎯 **Selected** — IDE Bootcamp Phase II, National Innovation Program 2025
- 💻 MERN Stack Developer Internship — Zealous Tech Corp
